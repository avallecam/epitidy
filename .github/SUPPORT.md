# Getting help with epitidy

Thanks for using epitidy. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/epitidy/issues) to make sure the 
